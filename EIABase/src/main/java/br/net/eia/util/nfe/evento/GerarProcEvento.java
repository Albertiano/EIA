 ...
 * @author EIA
 */
public class GerarProcEvento {    
    
    public String gerarProcNFeEnvi(String envNFe, String retEnvNfe) {
        try {
            Document document = documentFactory(envNFe);
            NodeList nodeListNfe = document.getDocumentElement().getElementsByTagName("evento");  
            NodeList nodeListInfNfe = document.getElementsByTagName("infEvento");  
            ...
            Logger.getLogger(GerarProcEvento.class.getName()).log(Level.SEVERE, null, ex);
        }            
        return null;          
    } 
    ...
    private String buildNFeProc(String xmlNFe, String xmlProtNFe) {  
        ...
        nfeProc.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>")  
            .append("<procEventoNFe versao=\"1.00\" xmlns=\"http://www.portalfiscal.inf.br/nfe\">")  
            .append(xmlNFe)  
            .append(xmlProtNFe)  
